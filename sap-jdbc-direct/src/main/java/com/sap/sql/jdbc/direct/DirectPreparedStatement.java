...
public abstract class DirectPreparedStatement extends DirectStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        DatastoreMetrics.noticeSql(directConn, sql, params);
    ...
    @Trace(leaf = true)
	public boolean execute(TraceContext var1) throws SQLException {
        if (sql == null) {
            sql = JdbcHelper.getSql((Statement) this);
        }
        DatastoreMetrics.noticeSql(directConn, sql, params);
    ...
    @Trace(leaf = true)
	public ResultSet executeQuery(TraceContext var1) throws SQLException {
        if (sql == null) {
            sql = JdbcHelper.getSql((Statement) this);
        }
        DatastoreMetrics.noticeSql(directConn, sql, params);
    ...
    @Trace(leaf = true)
	public int executeUpdate(TraceContext var1) throws SQLException {
        if (sql == null) {
            sql = JdbcHelper.getSql((Statement) this);
        }
        DatastoreMetrics.noticeSql(directConn, sql, params);
    ...
    @Trace(leaf = true)
	public int[] executeBatch(TraceContext var1) throws SQLException {
        if (sql == null) {
            sql = JdbcHelper.getSql((Statement) this);
        }
        DatastoreMetrics.noticeSql(directConn, sql, params);
