...
public class MessageMappings extends Properties {
	...
	private static MessageMappings instance = null;
	
	public static MessageMappings getInstance() {
		if(instance == null) {
			instance = new MessageMappings();
			try {
				instance.initialize();
			} catch (IOException e) {
				NewRelic.getAgent().getLogger().log(Level.FINE, e,  "Failed to load message mappings");
			}
		}
		return instance;
	}
