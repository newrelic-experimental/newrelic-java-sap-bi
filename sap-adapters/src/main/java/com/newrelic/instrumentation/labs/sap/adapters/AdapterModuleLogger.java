...
public class AdapterModuleLogger {
	...
	private static AdapterModuleLoggingConfig config;
	private static NRLabsHandler handler;

	protected static final String LOGFILENAME = "sap-module.log";

	public static void initialize() {
		config = new AdapterModuleLoggingConfig();
	...
	public static void logModuleContext(ModuleContext context, String source) {
		...
		if(LOGGER != null) {
			...
			jsonObj.put("ChannelID", context.getChannelID());
			jsonObj.put("ObjectType", "ModuleContext");
