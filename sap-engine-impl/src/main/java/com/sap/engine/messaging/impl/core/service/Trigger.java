...
@Weave
public abstract class Trigger extends AbstractAsyncCommand  {

	public Trigger(MessageController controller, TransportableMessage transportableMessage, String connectionName) {
