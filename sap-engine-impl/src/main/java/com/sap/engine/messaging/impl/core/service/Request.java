...
@Weave
public abstract class Request extends AbstractSyncCommand {

	public Request(MessageController controller, TransportableMessage message, String connectionName) {
